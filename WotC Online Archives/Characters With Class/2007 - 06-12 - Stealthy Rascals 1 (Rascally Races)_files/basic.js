...
/*
     FILE ARCHIVED ON 13:49:31 May 14, 2013 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 14:54:36 Jul 30, 2014.
...
//              win = window.open("/web/20130514134931/http://gatherer.wizards.com/gathererlookup.asp?name="+cardname, windowName , params);
//              win = window.open("/web/20130514134931/http://webstaging/Gatherer/CardDetails.aspx?name="+cardname, windowName , params);
//              win = window.open("/web/20130514134931/http://ww2.wizards.com/Gatherer/CardDetails.aspx?name="+cardname, windowName , params);
...
//              win = window.open("/web/20130514134931/http://gatherer.wizards.com/gathererlookup.asp?name="+cardname+"&set="+set, windowName, params);
//             win = window.open("/web/20130514134931/http://webstaging/Gatherer/CardDetails.aspx?name="+cardname+"&set="+set, windowName, params);
              //win = window.open("/web/20130514134931/http://ww2.wizards.com/Gatherer/CardDetails.aspx?name="+cardname+"&set="+set, windowName, params);
              //if (!win.opener) {
              //    win.opener = window;
              //}
              if (set != null && set != '')
