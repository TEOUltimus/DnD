...
/*
     FILE ARCHIVED ON 2:51:10 Nov 4, 2013 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 15:04:51 Jul 30, 2014.
...
//              win = window.open("/web/20131104025110/http://gatherer.wizards.com/gathererlookup.asp?name="+cardname, windowName , params);
//              win = window.open("/web/20131104025110/http://webstaging/Gatherer/CardDetails.aspx?name="+cardname, windowName , params);
//              win = window.open("/web/20131104025110/http://ww2.wizards.com/Gatherer/CardDetails.aspx?name="+cardname, windowName , params);
...
//              win = window.open("/web/20131104025110/http://gatherer.wizards.com/gathererlookup.asp?name="+cardname+"&set="+set, windowName, params);
//             win = window.open("/web/20131104025110/http://webstaging/Gatherer/CardDetails.aspx?name="+cardname+"&set="+set, windowName, params);
              //win = window.open("/web/20131104025110/http://ww2.wizards.com/Gatherer/CardDetails.aspx?name="+cardname+"&set="+set, windowName, params);
              //if (!win.opener) {
              //    win.opener = window;
              //}
              if (set != null && set != '')
