...
/*
     FILE ARCHIVED ON 3:29:30 May 29, 2014 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 14:49:08 Jul 30, 2014.
...
//              win = window.open("/web/20140529032930/http://gatherer.wizards.com/gathererlookup.asp?name="+cardname, windowName , params);
//              win = window.open("/web/20140529032930/http://webstaging/Gatherer/CardDetails.aspx?name="+cardname, windowName , params);
//              win = window.open("/web/20140529032930/http://ww2.wizards.com/Gatherer/CardDetails.aspx?name="+cardname, windowName , params);
...
//              win = window.open("/web/20140529032930/http://gatherer.wizards.com/gathererlookup.asp?name="+cardname+"&set="+set, windowName, params);
//             win = window.open("/web/20140529032930/http://webstaging/Gatherer/CardDetails.aspx?name="+cardname+"&set="+set, windowName, params);
              //win = window.open("/web/20140529032930/http://ww2.wizards.com/Gatherer/CardDetails.aspx?name="+cardname+"&set="+set, windowName, params);
              //if (!win.opener) {
              //    win.opener = window;
              //}
              if (set != null && set != '')
