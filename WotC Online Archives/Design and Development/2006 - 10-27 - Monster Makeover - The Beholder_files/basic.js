...
/*
     FILE ARCHIVED ON 20:39:32 Jun 11, 2013 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 16:39:38 Jul 30, 2014.
...
//              win = window.open("/web/20130611203932/http://gatherer.wizards.com/gathererlookup.asp?name="+cardname, windowName , params);
//              win = window.open("/web/20130611203932/http://webstaging/Gatherer/CardDetails.aspx?name="+cardname, windowName , params);
//              win = window.open("/web/20130611203932/http://ww2.wizards.com/Gatherer/CardDetails.aspx?name="+cardname, windowName , params);
...
//              win = window.open("/web/20130611203932/http://gatherer.wizards.com/gathererlookup.asp?name="+cardname+"&set="+set, windowName, params);
//             win = window.open("/web/20130611203932/http://webstaging/Gatherer/CardDetails.aspx?name="+cardname+"&set="+set, windowName, params);
              //win = window.open("/web/20130611203932/http://ww2.wizards.com/Gatherer/CardDetails.aspx?name="+cardname+"&set="+set, windowName, params);
              //if (!win.opener) {
              //    win.opener = window;
              //}
              if (set != null && set != '')
