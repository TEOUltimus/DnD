...
/*
     FILE ARCHIVED ON 18:28:06 Feb 19, 2014 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 15:27:00 Jul 30, 2014.
...
var gathererBaseURL = "beta.gatherer.wizards.com";
var expCodeLookup = {
    CON: "Conflux",
    ALA: "Shards of Alara",
    EVE: "Eventide",
...
//              win = window.open("/web/20140219182806/http://gatherer.wizards.com/gathererlookup.asp?name="+cardname, windowName , params);
//              win = window.open("/web/20140219182806/http://webstaging/Gatherer/CardDetails.aspx?name="+cardname, windowName , params);
//              win = window.open("/web/20140219182806/http://ww2.wizards.com/Gatherer/CardDetails.aspx?name="+cardname, windowName , params);
...
//              win = window.open("/web/20140219182806/http://gatherer.wizards.com/gathererlookup.asp?name="+cardname+"&set="+set, windowName, params);
//             win = window.open("/web/20140219182806/http://webstaging/Gatherer/CardDetails.aspx?name="+cardname+"&set="+set, windowName, params);
              //win = window.open("/web/20140219182806/http://ww2.wizards.com/Gatherer/CardDetails.aspx?name="+cardname+"&set="+set, windowName, params);
              //if (!win.opener) {
              //    win.opener = window;
              //}
              if (set != null && set != '')
